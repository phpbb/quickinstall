...
$lang = array_merge($lang, array(
	...
	'BOARD_CONFIG_SETTINGS_EXPLAIN'	=> 'The settings here are board wide settings for your phpBB board.',
	...
	'COOKIE_SECURE_EXPLAIN'	=> 'If your server is running via SSL set this to yes else leave as no. Having this enabled and not running via SSL will result in server errors during redirects.',
	...
	'IN_SETTINGS'			=> 'Manage your QuickInstall profiles.',
	'INSTALL_STYLES'		=> 'Install styles',
	'INSTALL_STYLES_EXPLAIN'	=> '&quot;Yes&quot; installs all styles found in [source]/styles. But only if the required parent style is available there too.',
	...
	'NO_ALT_ENV_FOUND'		=> 'The specified alternative environment doesn’t exist.',
	...
	'QI_LANG_SETTINGS'	=> 'QuickInstall language setting',
	'QI_MANAGE'			=> 'Manage boards',
	'QI_MANAGE_ABOUT'	=> 'Install new or delete not needed boards here.<br /><br />&quot;Board database and directory name:&quot; is the only field you have to fill, the others get filled with values from the selected profile.<br /><br />Click on the headings below the main options for more options, changes set here are not saved.',
