...
$lang = array_merge($lang, array(
	...
	'INSTALL_STYLES_EXPLAIN'	=> 'Install styles found in <code>sources/styles/</code>. Note only styles with the required parent style available can be installed.',
	...
	'MAX'					=> 'Max',
	'MIGHT_TAKE_LONG'		=> '<strong>Please note:</strong><br />Creation of the board can several seconds or minutes. Do not submit the form twice.',
	'MIN'					=> 'Min',
	...
	'PLAIN_TEXT'		=> '<strong>Note: QuickInstall stores passwords and usernames as plain text.</strong>',
